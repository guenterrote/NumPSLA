...
#define getOrientation_explicit(I,i,j,k) ( \
i<j&&j<k?I[i][j]> I[i][k]: \
i<k&&k<j?I[i][j]> I[i][k]: \
j<i&&i<k?I[i][j]<I[i][k]: \
j<k&&k<i?I[i][j]> I[i][k]: \
...
#define getOrientation(I,i,j,k) ((i<j) ^(j<k) ^(I[j][i]> I[j][k]) )  \
 \
 \
